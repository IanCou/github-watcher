...
class Settings:
    database_url: str = _env("DATABASE_URL", "sqlite:///./commit-watcher.db")  # type: ignore[assignment]
    ...
    user_agent: str = _env("USER_AGENT", "commit-watcher/0.1")  # type: ignore[assignment]
