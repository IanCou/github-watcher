...
commits_seen_total = Counter(
    "github_watcher_commits_seen_total", "New commits observed", ["watch"]
)
matches_total = Counter(
    "github_watcher_matches_total", "Commits that passed filters", ["watch"]
)
...
poll_errors_total = Counter(
    "github_watcher_poll_errors_total", "Polling errors", ["watch"]
)
